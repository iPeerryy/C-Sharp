...
{
    public partial class CtrCapitalFormula : CtrTiempoFormula
    {
        public CtrCapitalFormula()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                if (double.TryParse(txtTasaInteres.Text, out double tasa) &&
                    double.TryParse(txtInteres.Text, out double interes) &&
                    ...
                    DateTime.TryParse(txtFechaFinal.Text, out DateTime fechaFinal))
                {
                    ...
                    double capital = interes / (1 + (tasa / 100) * tiempo);
                    txtResultado.Text  = ("El capital calculado es: " + capital);
                }
                else
                {
