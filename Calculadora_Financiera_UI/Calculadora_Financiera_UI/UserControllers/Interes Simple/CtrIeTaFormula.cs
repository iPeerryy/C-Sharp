...
{
    public partial class CtrIeTaFormula : CtrTiempoFormula
    {
        public CtrIeTaFormula()
        {
            InitializeComponent();
        }

        private void CtrIeTaFormula_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    double interes = capital * (tasa / 100) * (TiempoAproximado(fechaInicial, fechaFinal) / 365);
